		...
		<?php
            ...
            $sqlup="SELECT * FROM aluno where matricula = '$matricula';";
            

            $resultadoaluno= mysqli_query($connect,$sqlup);
            
            $dados= mysqli_fetch_array($resultadoaluno);
			...
			if(isset($_POST['btn_Send'])){
				...
				if(empty($erros)){
                    ...
                    $sql = "UPDATE aluno set matricula='$matricula', nome='$nome', assistencia=$assist, FK_ETNIA_id_etnia=$etnia, FK_COTA_id_cota=$cota, FK_CURSO_id_curso=$curso, FK_STATUSM_id_status=$status, FK_RENDA_id_renda=$renda WHERE matricula = '$matricula';";
					...
					*/ 
					if(mysqli_query($connect, $sql)){
						...
						header('location: updatealuno.php');
					}
				}
			}
		?>	
			...
			<form class="col s12" method="post">
				...
				<div class="row">
					<div class="input-field col s10 pull-s1">
						  ...
						  <input id="matricula" type="text" name="matricula" value="<?php echo $matricula; ?>" readonly>
