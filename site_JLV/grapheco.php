        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                ...
                ['Task', 'Hours per Day'],
                ['De 0 a 2', <?php echo $graph[0]; ?>],
                ['De 2 a 5',<?php echo $graph[1]; ?> ],
                ['De 5 a 8', <?php echo $graph[2]; ?>],
                ['De 8 a 10', <?php echo $graph[3];?>],
                ['Mais de 10', <?php echo $graph[4]; ?>]
                ]);
                ...
                var options = {
                    ...
                    title: 'Perfil salarial no Campus IFES(Em salários minimos) - Serra',
